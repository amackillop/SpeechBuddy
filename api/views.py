...
#This is to make the path dynamic
...
def googleCall(request):
    if request.method == 'POST':
        ROOT="C:/Users/Gladiator/Desktop/Capestone/Capstone-Speech"
        # Save the audio file
...
#        fundementals = f0.tolist
        ...
        # Pitch Tracking
        f0 = pitchTrackingYIN(ROOT+'/SpeechBuddy/audio/output_mono.wav', (40, 300), 0.1, 0.25, 48e3, 1e3)
        #Get rid of files
##        if default_storage.exists(path):
##            default_storage.delete(path)
