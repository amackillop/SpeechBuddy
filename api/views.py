...
from api.YIN_Algorithm import pitchTrackingYIN

from api.capstoneModules.dataGenerator import convertToWav
...
def googleCall(request):
    if request.method == 'POST':
        ...
        path = default_storage.save('C:/Users/Austin/Desktop/school/Capstone/SpeechBuddy-master/audio/output.wav', ContentFile(dataDict.read()))
        #add wav to FLAC
        #print path
#        if default_storage.exists(path):
#            default_storage.delete(path)
        #fname = form["audio"]
        res = googleApiCall('C:/Users/Austin/Desktop/school/Capstone/SpeechBuddy-master/audio/output.flac')
        f0 = pitchTrackingYIN('http://127.0.0.1:8000/audio/output.wav', (40, 300), 0.1, 0.25, 44.1e3, 1e3)
#        fundementals = f0.tolist
        ...
        #print(res)
        return Response({"transcript": transcript, "confidence": confidence, "wpm": wpm, "indexArray": indexArray, "corpus": corpus, "tok": tok, "listSyn": listSyn, "pitch": f0})
    return Response({"message": "Hello, world!"})
